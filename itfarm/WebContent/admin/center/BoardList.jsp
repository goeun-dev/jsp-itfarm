...
<%
	...
	try {
		...
		if (column.equals("") || key.equals("")) {
			Query1 = "select count(RcdNo) FROM board2";
			Query2 = "select RcdNo, UsrName, UsrSubject,  UsrDate, UsrRefer, RcdLevel FROM board2 ORDER BY GrpNo DESC, RcdOrder ASC LIMIT "
					+ FirstRecord + " , " + PageRecords;
		} else {
			Query1 = "select count(RcdNo) FROM board2 WHERE " + column + " LIKE '%" + key + "%'";
			Query2 = "select RcdNo, UsrName, UsrSubject, UsrDate, UsrRefer, RcdLevel FROM board2 WHERE " + column
...
<section class="main">
	...
	<div id="wrap" align="center">
		<h1>문의 게시판 - 관리자 페이지</h1>
		<div class="search_div">
		<p>상세 검색</p>
		<form action="ProductSearch" class="search_form" method="get">
		</form>
		</div>
			<table class="list">
 ...
 %>
					...
					<td align="center"><a href="">답변</a></td>
