		...
		<table class="list table table-bordered table-sm">
			...
			${emp}
				<tr class="record">
					...
					<td align="center"><a href="ProductUpdate?productNum=${product.productNum}">상품 수정</a>
					</td>
					<td  align="center"><a href="Admin?command=product_deleteform&productNum=${product.productNum}">상품 삭제</a>
					</td>
				</tr>
			</c:forEach>
			</form>
