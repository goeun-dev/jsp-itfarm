  ...
  var chartDrowFun = {
    ...
    chartDrow : function(){
        ...
        function drawDashboard() {
          ...
          data.addColumn('number'   , '탈퇴회원수');
          data.addColumn('number'   , '가입회원수');
          ...
          console.log(data);
            ...
            var chart = new google.visualization.ChartWrapper({
              ...
              options     : {
                ...
                vAxis              : {minValue: 4,viewWindow:{min:0},gridlines:{count:-1},textStyle:{fontSize:12}},
        ...
        <div class="row">
            ...
            <div class="row">
				...
				<div class="search_div">
					<form action="Admin?command=member_day" class="search_form" method="post">
					<br>
						<label class="tlabel">조회기간</label>
                        ...
                        <div role="main" class="container mt-5" align="center">
							...
							<br>
								...
								<button onclick="location.href='Admin?command=member_day'"
								 class="btn btn-primary" type="submit">일별</button>
							...
							<div id="Line_Controls_Chart">
								<p style="width:100%; text-align: center;">일별 회원 가입현황</p>
						      <!-- 라인 차트 생성할 영역 -->
