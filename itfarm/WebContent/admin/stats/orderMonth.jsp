                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						<tr>
							...
							<td align="center">금월(${rc.month})</td>
							</c:if>
							<c:if test="${status.last}">
							<td align="center">전월(${rc.month})</td>
							</c:if>
							...
							<c:if test="${status.first}">
							<c:if test="${total3 < 0 }">
							<td rowspan="2" class="decrease" style="vertical-align: middle">
							<fmt:formatNumber value="${total3}" 
							type="number" pattern=".00"/> % 감소
							</td>
							</c:if>
							<c:if test="${total3 > 0}">
							<td rowspan="2" class="increase" style="vertical-align: middle">
							<fmt:formatNumber value="${total3}" 
