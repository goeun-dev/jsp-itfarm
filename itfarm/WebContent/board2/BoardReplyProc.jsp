...
try {
	...
	String Query1 = "SELECT max(RcdNo) FROM board2";
	...
	//------------------------------- 부모 레코드의 필드 값 추출	
	String Query2 = "SELECT GrpNo, RcdLevel, RcdOrder FROM board2 WHERE RcdNo=?";
	...
	String Query3 = "UPDATE board2 SET RcdOrder=RcdOrder+1 WHERE GrpNo=? AND RcdOrder>?";
	...
	//------------------------------- 답변 레코드 저장	
	String Query4 = "INSERT INTO board2 (RcdNo, GrpNo, UsrName, UsrSubject, UsrContent, UsrPass, UsrFileName, UsrFileSize, UsrDate, UsrRefer, RcdLevel, RcdOrder) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
