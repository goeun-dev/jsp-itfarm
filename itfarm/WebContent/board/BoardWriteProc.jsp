...
//------------------------- JDBC 설정
	...
	String Query1 = "SELECT max(RcdNo), max(GrpNo) FROM board1";
	...
	//---------------------------- 입력 질의 수행
	String Query2 = "INSERT INTO board1 (RcdNo, GrpNo, UsrName, UsrSubject, UsrContent, UsrPass, UsrFileName, UsrFileSize, UsrDate, UsrRefer, RcdLevel, RcdOrder) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
