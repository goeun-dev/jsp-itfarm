...
<%
	...
	try {
		...
		//---------------------------------- UsrRefer 필드값 1 증가
		String Query1 = "UPDATE board1 SET UsrRefer=UsrRefer+1 WHERE RcdNo=?";
		pstmt = conn.prepareStatement(Query1);

		pstmt.setInt(1, rno);
		pstmt.executeUpdate();

		String Query2 = "SELECT UsrName, UsrSubject, UsrContent, UsrFileName, UsrFileSize FROM board1 WHERE RcdNo=?";
			...
			<TABLE ALIGN=CENTER>
				...
				<TR class="bcnt-cnt"><br>
					...
					<%
						...
						%> <br><img style="width:50%;" src="../images/board/<%=filename%>"> 
					  <%
						}%>
