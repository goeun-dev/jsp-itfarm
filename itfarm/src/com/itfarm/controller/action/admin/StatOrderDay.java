...
public class StatOrderDay implements AdminAction {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map<String, String> dayRevenue = pDao.getDayRevenue("7", 1, startDate, endDate);
		Map<String, String> dayRefundRevenue = pDao.getDayRevenue("7", 2, startDate, endDate);
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("admin/stats/orderDay.jsp");
